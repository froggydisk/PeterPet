...
export const USERS: IUser[] = [
  {
    ...
    social: {twitter: 'froggydisk', dribbble: 'sewoomkim'},
    about:
      '도쿄 자취남 (백수)',
    avatar:
